...
Market data was obtained from **Yahoo Finance** using the Python library `yfinance`. We collected daily OHLCV data for the same 40 companies from **2023-01-01 to present**. For each company we computed:
...
We combine the market metrics with the financial data for further analysis.
